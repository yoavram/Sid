# -*- coding: utf-8 -*-
#
# Sid documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'Sid.tex', u'Sid Documentation',
   u'Yoav Ram', 'manual'),
]
...
man_pages = [
    (master_doc, 'sid', u'Sid Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Sid', u'Sid Documentation',
   author, 'Sid', 'One line description of project.',
   'Miscellaneous'),
]
